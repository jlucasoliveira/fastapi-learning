...
class UsersRepository(BaseRepository):
    ...
    async def register_new_user(self, *, new_user: UserCreate) -> UserInDB:
        user_with_same_email = await self.get_user_by_email(email=new_user.email)
        ...
        user_with_same_username = await self.get_user_by_username(username=new_user.username)
